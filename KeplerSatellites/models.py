...
class OrbitalElements(models.Model):
    ...
    mean_anaomaly = models.FloatField(blank=True, null=True)
    ...
    b_drag_term = models.CharField(max_length=7, blank=True, null=True)
...
class Satellite(models.Model):
    ...
    sat_cat_number = models.IntegerField(blank=True, null=True)
    ...
    object_type = models.CharField(max_length=5, blank=True, null=True)
    rcs_value = models.CharField(max_length=6, blank=True, null=True)
    rcs_size = models.CharField(max_length=6, blank=True, null=True)
    elset_classification = models.CharField(max_length=1, blank=True, null=True)
    international_designator = models.CharField(max_length=6, blank=True, null=True)
    launch_year = models.IntegerField(blank=True, null=True)
    launch_num = models.IntegerField(blank=True, null=True)
    launch_piece = models.IntegerField(blank=True, null=True)
