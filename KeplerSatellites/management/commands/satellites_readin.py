...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        norad_id_list = range(39, 40000, 1)
        print norad_id_list
        for norad_id in norad_id_list:
            ...
            satellite_cat = query("https://www.space-track.org/basicspacedata/query/class/satcat/NORAD_CAT_ID/"+str(norad_id)+"/metadata/false")
            ...
            # INSERT QUERY
            satellite_tle = query("https://www.space-track.org/basicspacedata/query/class/tle/NORAD_CAT_ID/"+str(norad_id)+"/metadata/false/distinct/true")
